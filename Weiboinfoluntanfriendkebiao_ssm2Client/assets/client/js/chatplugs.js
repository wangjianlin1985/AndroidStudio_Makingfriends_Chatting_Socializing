...
$(function(){
    ...
    $("#hobbyFriendList").data("property",JSON.stringify(fpp));
   // $("#recommandFriendList").data("property",JSON.stringify(fpp));
...
function toBiaoqian(){
	 ...
	 $.ajax({
         ...
         success: function(data){
         	$("#friend_hobbyid").refreshShowSelectMenu(data,"全部","id","name");
         	loadFriendHobbysub();
         }
 	});
}

function loadFriendHobbysub(){
	var value = $("#friend_hobbyid").val();
	...
	$.ajax({
         ...
         success: function(data){
         	$("#friend_hobbysubid").refreshShowSelectMenu(data,"全部","id","name");
         }
 	});
}

function loadUserByHobby(){
	var value = $("#friend_hobbysubid").val();
	if(value == null || value == ''){return;}
	$.ajax({
 		 url: clientUrl + "searchFriend",
         dataType: "json",
         type: 'post',
         data: {
         	"subid": value,
         ...
         success: function(data){
         	focuslist = data;
        	$("#hobbyFriendList").refreshShowListView(data);
         }
 	});
}
